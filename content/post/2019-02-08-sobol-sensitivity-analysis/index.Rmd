...
summary: Using mrgsolve package and approach to conduct pharmacokinetic modeling and Sobol sensitivity analysis
authors:
- admin
date: "2019-02-08T00:00:00Z"
lastmod: "2019-12-16T00:00:00Z"
output:
  blogdown::html_page:
    toc: true
    toc_depth: 2
categories: [sensitivity, pharmacokinetics, Sobol]
tags: [sensitivity]
projects: [PBPK]
...
For Windows OS, some build tools need to pre-install, such as Rtools. Also, be sure to assign the PATH of Rtools.
```{r}
