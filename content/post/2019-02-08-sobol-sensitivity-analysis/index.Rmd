...
summary: Using mrgsolve package and its approach to conduct pharmacokinetic modeling and Sobol sensitivity analysis
authors:
- admin
date: "2019-02-08"
lastmod: "`r Sys.Date()`"
output:
  blogdown::html_page:
    ...
    toc_depth: 2
projects: [PBPK]
categories: [pharmacokinetics, sensitivity]
